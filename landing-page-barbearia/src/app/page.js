    ...
    <div className={alterarTema ? estilos.escuro : estilos.claro}>
      ...
      <section className={estilos.secao_conteudo}>
        <main className={estilos.container_conteudo}>
          ...
          <p className={estilos.paragrafo2}> Nossos serviços são dedicados ao seu sucesso pessoal. Aqui temos uma equipe premiada que demonstrou o talento de mestres barbeiros em vários concursos de estilo. Deixe nosso barbeiro ser seu estilista pessoal e você nunca ficará desapontado.</p>
